    ...
    min-height: 138px
                ...
                <div class="container-fluid">
                   <div class="container-fluid row">
                    <h1 class=" bg-info col-5 text-center p-2 text-light rounded">Qui sommes-nous ?</h1>
                            ...
                            <div class="col-md-6">
                                <div class="card text-left m-1 border-danger">
                                    <div class="d-flex mt-2">
                                        <img class="m-2 rounded-circle" src="/img/dinar.jpg" width="150px" height="150px" alt=""/>
                                        <div class="card-body">
                                        ...
                                        <div class="card-body d-flex justify-content-around">
                                            <a href="https://github.com/electricpizzza/" class="fa fa-github"></a>
                                            <a href="https://twitter.com/pizzafordinar" class="fa fa-twitter"></a>
                                            <a href="mailto:zakariae.donar@gmail.com" class="fa fa-google"></a>
                                            <a href="https://www.linkedin.com/in/zakariae-dinar/" class="fa fa-linkedin"></a>
                                            <a href="https://www.instagram.com/electricpizzza/" class="fa fa-instagram"></a>
                                       </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card text-left m-1 border-danger">
                                    <div class="d-flex mt-2">
                                        <img class="m-2 rounded-circle" src="holder.js/100px180/" width="150px" height="150px" alt=""/>
                                        <div class="card-body">
